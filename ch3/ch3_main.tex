...
The CACC scenario working on a platoon can be illustrated as in Figure~\ref{fig_pre_fol}.
 ...
 \begin{figure}[h!]
    \centering
    \includegraphics[width=10cm]{ch3/img/SACC.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.8]{ch3/img/matlab_fc_2.eps}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.9]{ch3/img/matlab_fc_1.eps}
...
\begin{figure}[h!]
\centering
\includegraphics[width=10cm]{ch3/img/probleme_2.png}
\caption{Discrete-time model-based UIO}
\label{fig_dis_UIO}
\end{figure}
...
\begin{equation*}
    K =\begin{bmatrix}
        0.5000 & -0.001 & -0.2 & 2.2 \\
        -0.005 & 0.7 & -68.0 & 1004.2 
      \end{bmatrix}^{\top}.
\end{equation*} 
