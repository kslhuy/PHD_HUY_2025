...
Complementing these observer-centric designs, recent work has also formalized secure multi-sensor fusion under sensor attacks in CAV architectures \cite{YangLv2022SecureSensorFusion}.
For platoon-level operation, the vulnerability of cooperative strings to false-data injection has been explicitly connected to string stability degradation \cite{Biroon2022FDICACCPlatoon}, motivating trust-aware distributed estimation and control co-design.
