...
Figure~\ref{fig:controller_2 , fig:controller_3} shows the acceleration commands for vehicles 2 and 3. The trust-modulated $\gamma$ blending and the filter time constant $\tau_f = 0.2$ yield smooth transitions between the local (IDM) and cooperative (CACC) contributions, avoiding abrupt control jumps.
