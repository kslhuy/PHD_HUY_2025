...
\node[title] at (box.north west) {\color{curcolor}  Objectives};
...
% \renewcommand{\T}{\ensuremath{\mathrm{T}}}
...
\mtcaddchapter[#1] % Properly register with minitoc AND adds to TOC
\chapter*{#1}
% \addcontentsline{toc}{chapter}{#1} % Removed: \mtcaddchapter already adds to TOC
\markboth{#1}{#1}
...
\input{others/resume_francais_etendu}

\chapter{Abstract}\adjustmtc
