...
\usepackage[locale = US]{siunitx} % Pour gérer les unités
...
\usepackage[english,nohints,tight]{minitoc}		% Mini table des matières, en français
...
\usepackage[hyperref=true,natbib=true,
			...
			style=numeric,%authoryear, numeric ,  alphabetic
